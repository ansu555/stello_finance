...
export const config = {
  ...
  contracts: {
    ...
    priceFeedContractId: requireEnv(
      "PRICE_FEED_CONTRACT_ID"),
    usdcSacContractId: requireEnv("USDC_SAC_CONTRACT_ID"),
    eurcSacContractId: requireEnv("EURC_SAC_CONTRACT_ID"),
    yxlmSacContractId: requireEnv("YXLM_SAC_CONTRACT_ID"),
  },
